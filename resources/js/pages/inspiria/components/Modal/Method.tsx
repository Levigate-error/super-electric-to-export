...
const Method = ({ setModalState, currentReceipt }) => {
    const handleUpload = (e) => {
        uploadPhotoReceipt(e.target.files, currentReceipt).then((response: any) => {
    ...
    return (
        <React.Fragment>
            ...
            <a href="/Правила_программа_для_электриков_для_сайта-3.pdf" target="_blank" className="loyalty-modal__link">
                Правила акции
            </a>
        </React.Fragment>
    );
