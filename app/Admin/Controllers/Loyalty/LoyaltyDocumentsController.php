...
use App\Admin\Services\Loyalty\LoyaltyDocumentsAdminService;
 ...
 */
class LoyaltyDocumentsController extends BaseController
{
    protected const PAGE_HEADER = 'Программа лояльности - Полный список файлы';
     ...
     */
    public function __construct(LoyaltyDocumentsAdminService $service)
    {
