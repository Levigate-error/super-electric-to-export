...
use App\Admin\Services\Loyalty\GiftsAdminService;
...
{
    protected const PAGE_HEADER = 'Программа лояльности - Витрина призов';

    /**
     * @var LoyaltyDocumentsAdminService
     */
    protected $service;

    /**
     * FeedbackController constructor.
     * @param LoyaltyDocumentsAdminService $service
     */
    public function __construct(GiftsAdminService $service)
    {
    ...
    {
        return route('admin.loyalty-program.giftProducts.index');
    }
